...
document.getElementById("bq").onclick = function() {
  ...
  function kalimatakhir(){
      kalimat.innerHTML="";
  	new TypeIt("#kalimat", {
      strings: ["" + pesanAkhir1], startDelay: 10, speed: 35, cursor: true,
      afterComplete: function(){
         kalimat.innerHTML = pesanAkhir1;
         iden += 1;
         pesanAkhir1 = inip[iden];
         if(pesanAkhir1==inip[totalPesan+1]){ftoAwal.src=ftoAkhir.src;ftAwal.style="opacity:.8;margin-top:80px;transform: scale(.8);transition: all .8s ease";ftoAwal.style="width:auto;height:auto;border-radius:10px;background:rgba(255,255,255,.75);padding:10px";setInterval(berjatuhan,200);}
         //munculkembali();
      },}).go();
  }
